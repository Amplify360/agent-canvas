/**
 * Prototype data for the Transformation Map seed.
 *
 * Keep this file free of app/browser dependencies so it can be imported from
 * both the frontend and Convex backend.
 */

// ── Pressures ──────────────────────────────────────────────

export const MOCK_PRESSURES = [
  {
    id: 'p-1',
    type: 'external',
...
export const MOCK_OBJECTIVES = [
  ...
  },
  {
    id: 'obj-6',
    scope: 'department',
    title: 'Build proactive customer health intervention',
    description: 'Create a consistent, cross-system health view so at-risk customers are detected and engaged before churn.',
    departmentId: 'dept-cs',
    linkedPressureIds: ['p-6', 'p-2'],
  },
  {
  ...
  },
  {
    id: 'obj-8',
    scope: 'department',
    title: 'Standardize proposal and pricing operations',
    description: 'Reduce quote-cycle friction by replacing manual proposal creation with governed pricing and approval rules.',
    departmentId: 'dept-sales',
    linkedPressureIds: ['p-4', 'p-1'],
  },
  {
  ...
  },
  {
    id: 'obj-10',
    scope: 'department',
    title: 'Automate billing and collections operations',
    description: 'Remove manual invoice generation, payment tracking, and handoffs across billing and accounts receivable.',
    departmentId: 'dept-finance',
    linkedPressureIds: ['p-4'],
  },
  {
    id: 'obj-11',
    scope: 'department',
    title: 'Strengthen compliance and reporting readiness',
    description: 'Improve control posture and audit readiness so enterprise growth is not blocked by compliance gaps.',
    departmentId: 'dept-finance',
    linkedPressureIds: ['p-3'],
  },
];
